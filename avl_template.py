...
class AVLTree(object):
    ...
    def RL_rotate(self, node: AVLNode):
        ...
        if is_root:  # if node is root
            ...
            # grand's height didnt change, only right child and right right child
